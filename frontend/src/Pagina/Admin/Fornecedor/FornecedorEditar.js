...
function FornecedorEditar() {
  ...
  useEffect(()=>{
    fetch(`${baseUrl}/cliente/BuscarFornecedorporid?id=${id}`,
        {
            method:'GET',
            headers:{
            ...
            <div className="admConteudo">
                ...
                <h3>Contato</h3>
                        <table>
                            <tr>
                                <td><label>Prefixo: <br/>
                                <input type="number" name="prefixo" id="" onChange={handleChanage}/></label></td>
                                <td><label>Telefone: <br/>
                                <input type="number" name="telefone" id="" onChange={handleChanage}/></label></td>
                                <td><label>E-mail: <br/>
                                <input type="email" name="email" id="" onChange={handleChanage}/></label></td>
                            </tr>
                            <tr>
