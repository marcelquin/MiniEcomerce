...
function Cliente() {
    ...
    useEffect(() => {
        Axios
          .get("http://104.198.154.70:8080/cliente/ListarClientes")
      ...
      async function savedata(e){
        try{
          fetch('http://104.198.154.70:8080/cliente/NovoCliente', {
            method: 'POST',
            headers:{
      ...
      async function Editardata(e){
        try{
          fetch('http://104.198.154.70:8080/cliente/EdiarCliente', {
            method: 'POST',
            headers:{
              'Content-Type': 'application/x-www-form-urlencoded'
            },    
      ...
      async function Excluidata(e){
        try{
          fetch('http://104.198.154.70:8080/cliente/DeletarCliente', {
            method: 'POST',
            headers:{
              'Content-Type': 'application/x-www-form-urlencoded'
            },    
