...
function Produto() {
    ...
    useEffect(() => {
      ...
      async function savedata(e){
        try{
          fetch('http://104.198.154.70:8080/produto/NovoProduto', {
            method: 'POST',
            headers:{
    ...
    async function ReajusteValor(e){
        try{
          fetch('http://104.198.154.70:8080/produto/ReajustePreco', {
            method: 'PUT',
            headers:{
              'Content-Type': 'application/x-www-form-urlencoded'
            },    
      ...
      async function QueimaEstoque(e){
        try{
          fetch('http://104.198.154.70:8080/produto/QueimaEstoque', {
            method: 'PUT',
            headers:{
              'Content-Type': 'application/x-www-form-urlencoded'
            },    
